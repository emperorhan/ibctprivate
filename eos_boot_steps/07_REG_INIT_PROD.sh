...
./cleos.sh system delegatebw $ACCOUNT_77 $ACCOUNT_77 "1000000.0000 CR" "1000000.0000 CR" --transfer
...
./cleos.sh system delegatebw $ACCOUNT_78 $ACCOUNT_78 "1000000.0000 CR" "1000000.0000 CR" --transfer
...
./cleos.sh system delegatebw $ACCOUNT_79 $ACCOUNT_79 "1000000.0000 CR" "1000000.0000 CR" --transfer
...
./cleos.sh system delegatebw $ACCOUNT_86 $ACCOUNT_86 "1000000.0000 CR" "1000000.0000 CR" --transfer
...
./cleos.sh system delegatebw $ACCOUNT_87 $ACCOUNT_87 "1000000.0000 CR" "1000000.0000 CR" --transfer
...
./cleos.sh system delegatebw $ACCOUNT_88 $ACCOUNT_88 "1000000.0000 CR" "1000000.0000 CR" --transfer
...
./cleos.sh system delegatebw $ACCOUNT_80 $ACCOUNT_80 "1000000.0000 CR" "1000000.0000 CR" --transfer
